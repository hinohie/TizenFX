...
namespace Tizen.NUI
{
    ...
    internal class AsyncImageLoader : BaseHandle
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void PixelBufferLoadedSignalType(uint loadingTaskId, IntPtr pixelBufferList);
        ...
        public event EventHandler<PixelBufferLoadedEventArgs> PixelBufferLoaded
        {
            add
            {
                ...
                {
                    pixelBufferLoadedCallback = OnImageLoaded;
        ...
        private void OnPixelBufferLoaded(uint loadingTaskId, IntPtr pixelBufferList)
        {

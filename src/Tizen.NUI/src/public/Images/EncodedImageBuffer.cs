...
namespace Tizen.NUI
{
    ...
    public class EncodedImageBuffer : BaseHandle
    {
        ...
        /// <remarks>Hidden API: Only for inhouse or developing usage. The behavior and interface can be changed anytime.</remarks>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public EncodedImageBuffer(System.IO.Stream stream) : this(Interop.EncodedImageBuffer.New(VectorUnsignedChar.getCPtr(GetRawBuffrFromStreamHelper(stream))), true)
        {
        ...
        /// This funcion is private (exist only for Constructor.)
        /// </summary>
